            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="mb-6 md:mb-0">
                        <Link to="/" className="flex items-center">
                            <img
                                ...
                                className="mr-3 h-40 hover:border "
                                alt="Logo"
                            />
                        </Link>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                ...
                                <li>
                                    <Link to="http://www.linkedin.com/in/juhi2006" target='_blank' className="hover:underline">
                                        LinkedIn
                                    </Link>
                                </li>
                            </ul>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center">
                        © 2023
                        <a href="https://github.com/juh101/react_projects" target='_blank' className="hover:underline">
                            juhiahuja
                        </a>
                        . All Rights Reserved.
                    </span>
                        ...
                        <Link to="#" className="text-gray-500 hover:text-blue-800">
                            ...
                            >
                                <path
                                    ...
                                    clipRule="evenodd"
                                />
                                {/* Think of it like SVG’s drawing language. */}
                            </svg>
